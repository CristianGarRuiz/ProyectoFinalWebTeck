...
<body>
	<%
		...
		int precioIni = (int) request.getAttribute("precioIni");
		int precioFin = (int) request.getAttribute("precioFin");
		int idMarca = (int) request.getAttribute("idMarca");
...
<div class="container-fluid" id="contanierValores">
	<h3 style="text-align: center; margin-top: 9%;">Filtro Busqueda</h3>
	<h5>Filtrador precio Min : <%=precioIni%>  y  precio Final: <%=precioFin %></h5>
	<h5>
	<% int totalProducto = Busquedaproducto.size();   %>
		Total Productos :<%= totalProducto%></h5>
		</div>
	<div class="main-content  col-sm-5 col-md-12 col-lg-12">
		<div class="row">
			...
			<%
				for (ProductosTiendaPojo prod : Busquedaproducto) {
			%>
