...
<body>
	...
	<div class="main-content  col-sm-5 col-md-12 col-lg-12">
		...
		<%
			if (preguntas != null && pregunta != null && pregunta != "") {
				out.print("<Preguntas Frecuentes>");
				out.print("<br><br>");
				out.print("<table class=table table-hover table-responsive>");
				out.print("<th> Preguntas con Relacion :</th>");
				out.print("<th> Respuesta :</th>");
				out.print("</tr>");

				for (PreguntasPojo juga : preguntas) {

					out.print("<tr>");
					out.print("<td>" + juga.getNombre() + "</td>");
					out.print("<td>" + juga.getRespuesta() + "</td>");

				}
				out.print("</table>");

			} else {
				out.print("<h4>Dudas Frecuentes</h4>");
			}
		%>
